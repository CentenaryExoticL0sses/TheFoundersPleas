...
namespace TheFoundersPleas.World
{
    ...
    public class MapGeneratorConfig : ScriptableObject
    {
        ...
        [field: Header("Grid Layout & Borders")]
        ...
        [field: Header("Erosion")]
        [field: SerializeField, Range(0, 100)] 
        public int ErosionPercentage { get; set; } = 50;

        [field: Header("Climate Simulation")]
        [field: SerializeField, Range(0f, 1f)] 
        ...
        [field: Header("Biome Bands")]
        [field: SerializeField] 
        public float[] TemperatureBands { get; set; } = { 0.1f, 0.3f, 0.6f };
        [field: SerializeField] 
        public float[] MoistureBands { get; set; } = { 0.12f, 0.28f, 0.85f };
        [field: SerializeField]
